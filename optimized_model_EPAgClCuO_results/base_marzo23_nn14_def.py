...
path_exper=pathresults+"NN14_10000epochs_"+str(BATCH_SIZE)+"/"
...
y_val=np.reshape(y_val,(len(y_val),len(y_train[0])))
y_test=np.reshape(y_test,(len(y_test),len(y_train[0])))
...
data_INI=[path_data, norm_ener_type, norm_coulomb, num_atoms, frac_train, frac_val, epochs, BATCH_SIZE, id_matriz, id_Z, id_calcu, id_reducc, NN_type,perc_norm_ener,y1_norm_ener,y1,x1,max,min]
